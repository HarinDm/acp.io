<footer class="footer">
			<div class="wrapper">
				<div class="footer-block">
					...
					<div class="footer-block__col footer-block__about"><a class="page__link" href="#">О нас</a><a class="page__link" href="templates/pageTeamTemplate.php">Команда</a><a class="page__link" href="#">Фотоотчеты</a><a class="page__link" href="#">Контакты</a><a class="page__link" href="#">СМИ о нас</a></div>
